			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
						<h2 class="footer-heading"><a href="#" class="logo">Movie Sprint</a></h2>
              ...
              <li><a href="#" class="py-1 d-block">Seat Selection</a></li>
              <li><a href="#" class="py-1 d-block">Great Experience</a></li>
              <li><a href="#" class="py-1 d-block">Perfect Secure Payment</a></li>
            </ul>
					</div>
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
	            ...
	            <a href="#" class="tag-cloud-link">Theatres</a>
	            <a href="#" class="tag-cloud-link">Seat availability</a>
	            <a href="#" class="tag-cloud-link">Food services</a>
	          </div>
					</div>
					<div class="col-md-6 col-lg-3 mb-md-0 mb-4">
