<?php 
	...
	session_start();
	//fixing url so server can grab them i.e creating base url
	define("APPURL", "http://localhost/movie-booking");
	define("MOVIEIMAGES", "http://localhost/movie-booking/admin-panel/movies-admins/movie_images");
	define("THEATRESIMAGES", "http://localhost/movie-booking/admin-panel/theatres-admins/theatre_images");
...
<html lang="en">
  <head>
    <title>Movie Sprint - Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body>
			...
			<div class="container">
				<div class="row justify-content-between">
						<div class="col d-flex align-items-center">
							<p class="mb-0 phone"><span class="mailus">Phone no:</span> <a href="#">+91 8050781081</a> or <span class="mailus">email us:</span> <a href="#">moviesprint@email.com</a></p>
						</div>
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="<?php echo APPURL; ?>">Movie<span>Sprint</span></a>
