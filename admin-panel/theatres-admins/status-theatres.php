...
if(isset($_GET['id'])){
  ...
  if(isset($_POST['submit'])){
    ...
    // } else {
      ...
      $update = $conn->prepare("UPDATE theatres SET status = :status WHERE id='$id'");
      $update->execute([
      ":status" => $status
    ]);
...
?>
       <div class="row">
        <div class="col">
          ...
          <form method="POST" action="status-theatres.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
                <!-- Email input -->
