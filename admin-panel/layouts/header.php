<?php
  ...
  define("ADMINURL","http://localhost/movie-booking/admin-panel");
    ...
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/movies-admins/show-movies.php" style="margin-left: 20px;">MOVIES</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMINURL; ?>/theatres-admins/show-theatres.php" style="margin-left: 20px;">THEATRES</a>
          </li>
          <li class="nav-item">
