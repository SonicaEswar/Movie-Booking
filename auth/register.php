...
<?php
// post request as its a form submission
  ...
  if(isset($_POST['submit'])) {
    if(empty($_POST['username']) OR empty($_POST['email']) OR empty($_POST['password'])) {
      ...
      //grabbing the data and storing it in our db 
      ...
      $stmt = $conn->prepare("CALL InsertUser(:username, :email, :mypassword)");
      $stmt->bindParam(':username', $username, PDO::PARAM_STR);
      $stmt->bindParam(':email', $email, PDO::PARAM_STR);
      $stmt->bindParam(':mypassword', $password, PDO::PARAM_STR);
